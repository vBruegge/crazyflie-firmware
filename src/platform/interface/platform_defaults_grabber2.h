...
#define MLESO_GAIN_THROTTLE 1.33
#define MLESO_GAIN_ROLL 6.67*360.0/__UINT16_MAX__
#define MLESO_GAIN_PITCH 25.7*360.0/__UINT16_MAX__
#define MLESO_GAIN_YAW 1.478*360.0/__UINT16_MAX__