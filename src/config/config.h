...
#define SERVO_GRIPPER_TASK_PRI  0
#define SPRING_GRIPPER_TASK_PRI 0
...
#define SERVO_GRIPPER_TASK_NAME "SERVO-GRIPPERDECK"
#define SPRING_GRIPPER_TASK_NAME "SPRING-GRIPPERDECK"
...
#define STABILIZER_TASK_STACKSIZE     (4 * configMINIMAL_STACK_SIZE)
...
#define SERVO_GRIPPER_TASK_STACKSIZE  configMINIMAL_STACK_SIZE
#define SPRING_GRIPPER_TASK_STACKSIZE configMINIMAL_STACK_SIZE
